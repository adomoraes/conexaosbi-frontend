...
export default function Episode({ episode, transcript }) {
  ...
  const title = `${episode.title} - Conexão SBI - Episode ${episode.episodeNumber}`;

  const imageURL =
    episode.episodeImage ??
    'https://infectologia.org.br/wp-content/uploads/2024/12/logo.png';
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:site_name" content="Conexão SBI" />
      ...
      <article className="py-16 lg:py-36">
        <Container>
          ...
          <section className="mt-14">
            ...
            {transcript && (
              <div
                className="mb-2 hidden border-b border-t border-blue-500 bg-blue-100 px-4 py-3 text-blue-700"
                role="alert"
              >
