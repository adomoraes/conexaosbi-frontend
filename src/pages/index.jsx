        ...
        <div className="flex flex-col items-start sm:flex-row">
          ...
          {episode.episodeImage && (
            <Image
              ...
              width={96} // Example width (adjust as needed)
              height={96} // Example height (adjust as needed)
...
export default function Home({ episodes }) {
  ...
  const description =
    'Ouça o Conexão SBI, o podcast médico da Sociedade Brasileira de Infectologia.' +
    'Conteúdo científico, entrevistas com especialistas e atualizações em saúde, ' +
    'direto no seu player favorito.';
  ...
  const imageURL =
    'http://wrecktecnologia1.hospedagemdesites.ws/tino/sbi/wp-content/uploads/2025/04/www.png';

  return (
    <>
      <Head>
        <title>
          Conexão SBI - Conteúdo que aproxima, conhecimento que move.
        </title>
        ...
        <link
          rel="shortcut icon"
          href="https://infectologia.org.br/wp-content/uploads/2020/08/favicon-sbi.ico"
          type="image/x-icon"
        ></link>
        <link
